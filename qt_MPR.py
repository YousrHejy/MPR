...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Create a VTK widget 1( Left Up)
        self.vtk_widget = QVTKRenderWindowInteractor(self.widget_v1)
        self.verticalLayout_7.addWidget(self.vtk_widget)
        # Initialize VTK components
        self.initialize_vtk_1()

        # Create a VTK widget 2 (Right Up)
        self.vtk_widget = QVTKRenderWindowInteractor(self.widget_img)
        self.verticalLayout_8.addWidget(self.vtk_widget)
        # Initialize VTK components
        self.initialize_vtk_2()

        # Create a VTK widget 3( Left Down)
        self.vtk_widget = QVTKRenderWindowInteractor(self.widget_v3)
        self.verticalLayout_10.addWidget(self.vtk_widget)
        # Initialize VTK components
        self.initialize_vtk_3()

        # Create a VTK widget 4 (Right Down)
        self.vtk_widget = QVTKRenderWindowInteractor(self.widget_v2_2)
        self.verticalLayout_11.addWidget(self.vtk_widget)
        # Initialize VTK components
        self.initialize_vtk_4()




        
        ########### Finish Main window Design ###############
    ...
    def initialize_vtk_3(self):
        ...
        # Create a VTK cylinder
        cylinder_source = vtk.vtkCylinderSource()
        cylinder_source.SetRadius(4.0)
        cylinder_source.SetHeight(5.0)
        cylinder_mapper = vtk.vtkPolyDataMapper()
        cylinder_mapper.SetInputConnection(cylinder_source.GetOutputPort())
        cylinder_actor = vtk.vtkActor()
        cylinder_actor.SetMapper(cylinder_mapper)
        self.renderer.AddActor(cylinder_actor)
        # Set background color
        self.renderer.SetBackground(0.5, 0.5, 0.7)
        # Reset camera
        self.renderer.ResetCamera()
        # Start interaction
        self.renwin.Render()

    def initialize_vtk_4(self):
        # Create a VTK renderer
        self.renderer = vtk.vtkRenderer()
        # Create a VTK render window
        self.renwin = self.vtk_widget.GetRenderWindow()
